                ...
                <div className="flex flex-col xl:flex-row gap-[1.875rem]">
                    ...
                    <div className="xl:w-[54%] order-2 xl:order-none">
                        <form action="" method="post" onSubmit={(e) => e.preventDefault()}
                            className="flex flex-col gap-6 p-6 md:p-10 bg-white/5 rounded-xl border border-white/20 shadow-md shadow-black/20"
                        >
                            <h3 className="text-4xl text-accent">Let&#39;s work together</h3>
                            <p className="text-white/60">
                                Get in touch to discuss your project needs and bring your ideas to life.
                            </p>
                            {/* Inputs */}
